...
export default function Chatbot() {
    ...
    return (
        <>
            <div className={`fixed z-50 flex flex-col items-end gap-4 font-sans antialiased
        ${isExpanded
      ...
      `}>
          ...
          `}
                >
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-white/80 dark:bg-zinc-900/80 border-b border-zinc-100 dark:border-zinc-800/50 backdrop-blur-sm sticky top-0 z-10">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <h3 className="font-semibold text-zinc-900 dark:text-zinc-100 text-sm leading-tight">IRAssistant</h3>
                ...
                {/* Toggle Button (Only visible when not expanded) */}
                {!isExpanded && (
                    <button
                        onClick={toggleOpen}
                        className={`
